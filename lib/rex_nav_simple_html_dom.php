 ...
 * @package PlaceLocalInclude
 */
class rex_nav_simple_html_dom_node
{
...
class rex_nav_simple_html_dom
{
    ...
    protected function prepare($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
    {
        ...
        $this->root = new rex_nav_simple_html_dom_node($this);
        $this->root->tag = 'root';
    ...
    protected function parse()
    {
        ...
        // text
        $node = new rex_nav_simple_html_dom_node($this);
        ++$this->cursor;
    ...
    function createElement($name, $value=null) {return @rex_nav_simple_html_dom::str_get_html("<$name>$value</$name>")->first_child();}
    function createTextNode($value) {return @end(rex_nav_simple_html_dom::str_get_html($value)->nodes);}
    function getElementById($id) {return $this->find("#$id", 0);}
    function getElementsById($id, $idx=null) {return $this->find("#$id", $idx);}
    function getElementByTagName($name) {return $this->find($name, 0);}
